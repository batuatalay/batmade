...
<head>
  ...
  <title><?=strtolower($args['header'])?> | Bestet</title>
    ...
    <?php
        if($args['headerType'] == "services") { ?>
            <body class="services-details-page">
                <header id="header" class="header d-flex align-items-center sticky-top " style="background-color: #048c6d; max-height: 7em;">
        <? }else { ?>

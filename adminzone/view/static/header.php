                        ...
                        <div class="nano-content">
                            <nav id="menu" class="nav-main" role="navigation">
                                ...
                                <ul class="nav nav-main">
                                    ...
                                    <li class="nav-parent <?= ($args['active'] == "categories") ? "nav-expanded nav-active" : ""; ?>">
                                        <a class="nav-link">
                                        ...
                                        <ul class="nav nav-children">
                                            <li>
                                                <a class="nav-link" href="category/add" target = "_self">
                                                    Ekle
                                                </a>
                                            </li>
                                            <li>
                                    ...
                                    <li class="nav-parent <?= ($args['active'] == "pages") ? "nav-expanded nav-active" : ""; ?>">
                                        <a class="nav-link">
                                        ...
                                        <ul class="nav nav-children">
                                            <li>
                                                <a class="nav-link" href="page/add" target = "_self">
                                                    Ekle
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav-link" href="page" target = "_self">
                                                    Yönet
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                     <li class="nav-parent <?= ($args['active'] == "managers") ? "nav-expanded nav-active" : ""; ?>">
                                        <a class="nav-link">
                                            <i class="bx bx-male" aria-hidden="true"></i>
                                            <span>Yöneticiler</span>
                                        </a>
                                        <ul class="nav nav-children">
                                            <li>
                                                <a class="nav-link" href="manager/add" target = "_self">
                                                    Ekle
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav-link" href="manager" target = "_self">
                                                    Yönet
                                                </a>
                                        </ul>
                                    </li>
